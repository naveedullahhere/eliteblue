            ...
            <div className="col-lg-6 col-12 my-auto">
              <div className="inner">
                <div className="head">
                  ...
                  <h2 className='heading text-white' style={{ textTransform: 'unset' }}>Ecommerce Software Development<span className="dot">.</span></h2>
                </div>
              </div>
            </div>
                        ...
                        <div className="col-lg-6 col-12 my-auto">
                            <div className="inner">
                                <div className="head">
                                    ...
                                    <h2 className='heading'>Ecommerce Software Development<span className="dot">.</span></h2>
                                </div>
                            </div>
