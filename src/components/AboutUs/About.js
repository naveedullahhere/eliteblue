        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 col-12 my-auto">
              <div className="inner">
                <div className="head">
                  <h2 className='heading'>Introduction<span className="dot">.</span></h2>
                  <p className="para">we design and develop web and mobile applications for our clients worldwide</p>
                </div>
              </div>
            </div>
